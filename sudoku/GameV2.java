...
public class GameV2 implements MouseListener {
	...
	private void createView() {
    	...
    	newGameV2 = new JMenuItem("Nouveau");
...
//    	doAction.setIcon(new ImageIcon(getClass().getResource("pictures/do.png")));
    	...
    	timer = new Timer();
    	time = new JLabel(chrono.getDureeTxt());
	...
	private void createController() {
		...
		// barre de menu
		// Nouvelle grille
		newGameV2.addActionListener(new ActionListener() {
